...
/* harmony export */ });
/* harmony import */ var _chunk_P4SH322Z_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-P4SH322Z.js */ "./node_modules/.taro/weapp/prebundle/chunk-P4SH322Z.js");
/* harmony import */ var _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-UZRWPHG2.js */ "./node_modules/.taro/weapp/prebundle/chunk-UZRWPHG2.js");
/* harmony import */ var _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-44WASECX.js */ "./node_modules/.taro/weapp/prebundle/chunk-44WASECX.js");
/* harmony import */ var _chunk_OQNP5UWT_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-OQNP5UWT.js */ "./node_modules/.taro/weapp/prebundle/chunk-OQNP5UWT.js");




// node_modules/@tarojs/plugin-framework-react/dist/runtime.js
(0,_chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.init_shared_esm)();
(0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.init_runtime_esm)();
var reactMeta = {
    PageContext: _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.EMPTY_OBJ,
    R: _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.EMPTY_OBJ
};
...
function isClassComponent(R, component) {
    ...
    return (0,_chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(component.render) || !!(prototype === null || prototype === void 0 ? void 0 : prototype.isReactComponent) || prototype instanceof R.Component;
}
function ensureIsArray(item) {
    if ((0,_chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.isArray)(item)) {
        return item;
    } else {
        return item ? [
            item
...
function setRouterParams(options) {
    _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.router = Object.assign({
...
var createTaroHook = (lifecycle)=>{
    return (fn)=>{
        ...
        React.useLayoutEffect(()=>{
            let inst = instRef.current = (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.getPageInstance)(id);
            let first = false;
            if (!inst) {
                first = true;
            ...
            if ((0,_chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(inst[lifecycle])) {
                inst[lifecycle] = [
                    inst[lifecycle],
                    callback
                ];
            ...
            if (first) {
                (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.injectPageInstance)(inst, id);
            }
            return ()=>{
                ...
                } else if ((0,_chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.isArray)(list)) {
...
var useRouter = (dynamic = false)=>{
    ...
    return dynamic ? _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.router : React.useMemo(()=>_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.router, []);
};
...
var ReactDOM$1;
var Fragment;
var pageKeyId = (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.incrementId)();
function setReconciler(ReactDOM2) {
    _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("getLifecycle", function(instance, lifecycle) {
        lifecycle = lifecycle.replace(/^on(Show|Hide)$/, "componentDid$1");
        return instance[lifecycle];
    });
    _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("modifyMpEvent", function(event) {
        event.type = event.type.replace(/-/g, "");
    });
    _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("batchedEventUpdates", function(cb) {
        ReactDOM2.unstable_batchedUpdates(cb);
    });
    _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("mergePageInstance", function(prev, next) {
        if (!prev || !next) return;
...
function connectReactPage(R, id) {
    return (Page)=>{
        ...
        const inject = (node)=>node && (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.injectPageInstance)(node, id);
        ...
        if (reactMeta.PageContext === _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.EMPTY_OBJ) {
            reactMeta.PageContext = R.createContext("");
        }
        return class PageWrapper extends R.Component {
            static getDerivedStateFromError(error) {
                var _a, _b;
                (_b = (_a = _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.app) === null || _a === void 0 ? void 0 : _a.onError) === null || _b === void 0 ? void 0 : _b.call(_a, error.message + error.stack);
                return {
                    hasError: true
                };
            }
...
function createReactApp(App, react, dom, config) {
    if (true) {
        (0,_chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.ensure)(!!dom, "\u6784\u5EFA React/Nerv \u9879\u76EE\u8BF7\u628A process.env.FRAMEWORK \u8BBE\u7F6E\u4E3A 'react'/'nerv' ");
    }
    reactMeta.R = react;
    ...
    function renderReactRoot() {
        ...
        let appId = "app";
        if (false) {}
        const container = _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.document$1.getElementById(appId);
    ...
    const [ONLAUNCH, ONSHOW, ONHIDE] = _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.hooks.call("getMiniLifecycleImpl").app;
    ...
    function triggerAppHook(lifecycle, ...option) {
        const instance = (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.getPageInstance)(HOOKS_APP_ID);
        if (instance) {
            const app = getAppInstance();
            const func = _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.hooks.call("getLifecycle", instance, lifecycle);
            if (Array.isArray(func)) {
                func.forEach((cb)=>cb.apply(app, option));
            }
        }
    }
    _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.app = appObj;
    return appObj;
}
var getNativeCompId = (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.incrementId)();
var h;
var ReactDOM;
function initNativeComponentEntry(R, ReactDOM2) {
    ...
    class Entry extends R.Component {
        componentDidMount() {
            _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.app = this;
        }
        mount(Component, compId, getCtx) {
            const isReactComponent = isClassComponent(R, Component);
            const inject = (node)=>node && (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.injectPageInstance)(node, compId);
            const refs = isReactComponent ? {
                ref: inject
            } : {
                forwardedRef: inject,
        ...
        unmount(compId) {
            ...
            this.setState({
                ...
                (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.removePageInstance)(compId);
            });
        }
        render() {
            const components = this.state.components;
    ...
    const app = _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.document$1.getElementById("app");
...
function createNativeComponentConfig(Component, react, reactdom, componentConfig) {
    ...
    const componentObj = {
        ...
        created () {
            if (!_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.app) {
        ...
        attached () {
            ...
            _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.app.mount(Component, compId, ()=>this);
        },
        ready () {
            (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.safeExecute)(this.compId, "onReady");
        },
        detached () {
            _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.app.unmount(this.compId);
        },
        pageLifetimes: {
            show (options) {
                (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.safeExecute)(this.compId, "onShow", options);
            },
            hide () {
                (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.safeExecute)(this.compId, "onHide");
            }
        },
        methods: {
            eh: _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.eventHandler,
            onLoad (options) {
                (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.safeExecute)(this.compId, "onLoad", options);
            },
            onUnload () {
                (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.safeExecute)(this.compId, "onUnload");
            }
        }
    };
    function setCurrent(compId) {
        ...
        if (_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.page === currentPage) return;
        _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.page = currentPage;
        const route = currentPage.route || currentPage.__route__;
        const router = {
            params: currentPage.options || {},
            path: (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.addLeadingSlash)(route),
            $taroPath: compId,
            onReady: "",
            onHide: "",
            onShow: ""
        };
        _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.Current.router = router;
    ...
    if (Component.onShareAppMessage || ((_a = Component.prototype) === null || _a === void 0 ? void 0 : _a.onShareAppMessage) || Component.enableShareAppMessage) {
        componentObj.methods.onShareAppMessage = function(options) {
            ...
            if (target) {
                const id = target.id;
                const element = _chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.document$1.getElementById(id);
                if (element) {
                    target.dataset = element.dataset;
                }
            }
            return (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.safeExecute)(this.compId, "onShareAppMessage", options);
        };
    }
    if (Component.onShareTimeline || ((_b = Component.prototype) === null || _b === void 0 ? void 0 : _b.onShareTimeline) || Component.enableShareTimeline) {
        componentObj.methods.onShareTimeline = function() {
            return (0,_chunk_UZRWPHG2_js__WEBPACK_IMPORTED_MODULE_1__.safeExecute)(this.compId, "onShareTimeline");
        };
    }
    return componentObj;
}
_chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("initNativeApi", function(taro) {
    for(const hook in taroHooks){
        taro[hook] = taroHooks[hook];
    }
});
if (true) {
    const options = ((0,_chunk_P4SH322Z_js__WEBPACK_IMPORTED_MODULE_0__.init_preact_module)(), (0,_chunk_OQNP5UWT_js__WEBPACK_IMPORTED_MODULE_3__.__toCommonJS)(_chunk_P4SH322Z_js__WEBPACK_IMPORTED_MODULE_0__.preact_module_exports)).options;
    ...
    options.diffed = function(newVNode) {
        const domProp = Object.keys(newVNode).find((k)=>{
            var _a;
            return (_a = newVNode[k]) === null || _a === void 0 ? void 0 : _a.setAttribute;
        });
        ...
        if (dom) {
            for(const propName in newVNodeProps){
                ...
                if (propValue === false && dom.props[propName] === void 0) {
    ...
    _chunk_44WASECX_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("modifyMpEvent", (e)=>{
        const type = e.type;
        if (type === "tap") {
            e.type = "click";
        } else if (type === "focus") {
